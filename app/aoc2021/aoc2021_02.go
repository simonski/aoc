...
func (app *Application) Y2021D02P1() {
	x := 0
	y := 0
	for _, line := range strings.Split(DAY_2021_02_TEST_DATA, "\n") {
	...
	fmt.Printf("2021 02 part 1, test x=%v, y=%v, x*y=%v\n", x, y, x*y)

	x = 0
	y = 0
	for _, line := range strings.Split(DAY_2021_02_DATA, "\n") {
		splits := strings.Split(line, " ")
		direction := splits[0]
		value, _ := strconv.Atoi(splits[1])
		if direction == "forward" {
	...
	fmt.Printf("2021 02 part 1, real x=%v, y=%v, x*y=%v\n", x, y, x*y)
...
func (app *Application) Y2021D02P2() {
	...
	fmt.Printf("2021 02 part 2, test x=%v, y=%v, aim=%v, x*y=%v\n", x, y, aim, x*y)
	...
	fmt.Printf("2021 02 part 2,  x=%v, y=%v, aim=%v, x*y=%v\n", x, y, aim, x*y)
