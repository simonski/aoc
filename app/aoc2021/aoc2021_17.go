...
func test_d17(min_x int, max_x int, initial_xv int, max_y int, min_y int, initial_yv int, x_drag int, y_drag int) (*HitDB, *HitDB) {
...
func (app *Application) Y2021D17P1() {
	...
	x_db1, y_db1 := test_d17(min_x, max_x, initial_xv, max_y, min_y, initial_yv, x_drag, y_drag)
	x_db1.Debug("x")
	y_db1.Debug("y")
