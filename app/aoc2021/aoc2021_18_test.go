...
func Test_AOC2021_18_Split1(t *testing.T) {
	p := Pair{}
	value := "10"
	expected := "[5,5]"
...
func Test_AOC2021_18_Split2(t *testing.T) {
	p := Pair{}
	value := "11"
	expected := "[5,6]"
	actual := p.Split(value)
...
func Test_AOC2021_18_Split3(t *testing.T) {
	p := Pair{}
	value := "12"
	expected := "[6,6]"
	actual := p.Split(value)
...
func Test_AOC2021_18_SplitAt(t *testing.T) {
	value := "[12,4]"
	p := NewPair(value)
	expected := "[[6,6],4]"
	p.Reduce()
...
func Test_AOC2021_18_FindPair_1(t *testing.T) {
...
func Test_AOC2021_18_FindPair_2(t *testing.T) {
	// [[[[[9,8],1],2],3],4] becomes [[[[0,9],2],3],4] (the 9 has no regular number to its left, so it is not added to any regular number).
	line := "[[[[[9,8],1],2],3],4]"
	p := NewPair(line)
	// expected := "[[[[0,9],2],3],4]"
...
func Test_AOC2021_18_FindPairToExplode_1(t *testing.T) {
...
func Test_AOC2021_18_Explode_1(t *testing.T) {
	// [[[[[9,8],1],2],3],4] becomes [[[[0,9],2],3],4] (the 9 has no regular number to its left, so it is not added to any regular number).
	line := "[[[[[9,8],1],2],3],4]"
	p := NewPair(line)
	index := p.FindIndexOfFifthPair(line)
...
func Test_AOC2021_18_Reduce_1(t *testing.T) {
	// [[[[[9,8],1],2],3],4] becomes [[[[0,9],2],3],4] (the 9 has no regular number to its left, so it is not added to any regular number).
...
func Test_AOC2021_18_Reduce_2(t *testing.T) {
...
func Test_AOC2021_18_Reduce_3(t *testing.T) {
...
func Test_AOC2021_18_Reduce_4(t *testing.T) {
...
func Test_AOC2021_18_Reduce_5(t *testing.T) {
...
func Test_FindIndexOfRegularNumberGreaterOrEqualToTen(t *testing.T) {
...
func Test_AOC2021_18_Add_FindIndexOfFifthPair(t *testing.T) {
...
func Test_AOC2021_18_Add_1(t *testing.T) {
...
func Test_AOC2021_18_Add_0(t *testing.T) {
...
func Test_AOC2021_18_Add_2(t *testing.T) {
...
func Test_AOC2021_18_Add_3(t *testing.T) {
...
func Test_AOC2021_18_Add_4(t *testing.T) {
...
func Test_AOC2021_18_Add_5(t *testing.T) {
