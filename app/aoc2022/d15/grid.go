...
func (g *Grid) CountCannotsForRow_V2(row int) (int, int) {
	// go over each point left to right
	...
	for _, sensor := range sensors {
		...
		// for each sensor, make a straight line to the row as teh shortest distance
	...
	return unknown, known // could_be_beacon, could_not_be_beacon // , line
}
