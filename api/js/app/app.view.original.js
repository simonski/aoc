...
App.View = {
	...
	drawLoggedInPage : function() {
		...
		$("#username").html(App.Model.User.username);

		$(".button_overview").click(App.View.onOverviewButtonClicked);
		$(".button_my_profile").click(App.View.onMyProfileButtonClicked);

		$("#button_site_v1").click(function() {
			window.location = "/";
		});
		$("#button_site_v2").click(function() {
			window.location = "/v2";
		});
		$("#button_logout").click(App.View.onLogoutButtonClicked);
	 ...
	 * @param callback
	 */
	drawTemplate : function(templateName, node, callback) {
		Log.d("App.View.drawTemplate(" + templateName + ")");
